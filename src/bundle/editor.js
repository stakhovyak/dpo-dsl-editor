...
// ../../../.cache/deno/npm/registry.npmjs.org/ace-builds/1.43.2/src-noconflict/ace.js
var require_ace = __commonJS({
  "../../../.cache/deno/npm/registry.npmjs.org/ace-builds/1.43.2/src-noconflict/ace.js"(exports, module) {
    (function() {
      ...
      var define2 = function(module2, deps, payload) {
        if (typeof module2 !== "string") {
          if (define2.original) define2.original.apply(this, arguments);
          else {
    ...
    ace.define("ace/config", [
      ...
      exports2.loadModule = function(moduleId, onLoad) {
        ...
        var load = function(module3) {
          if (module3 && !exports2.$loading[moduleName]) return onLoad && onLoad(module3);
          if (!exports2.$loading[moduleName]) exports2.$loading[moduleName] = [];
          exports2.$loading[moduleName].push(onLoad);
          if (exports2.$loading[moduleName].length > 1) return;
          var afterLoad = function() {
            loader(moduleName, function(err, module4) {
              if (module4) exports2.$loaded[moduleName] = module4;
              exports2._emit("load.module", {
                name: moduleName,
                module: module4
              });
          ...
          if (!exports2.get("packaged")) return afterLoad();
      ...
      var Range = (
        ...
        function() {
          ...
          Range2.prototype.collapseRows = function() {
            if (this.end.column == 0) return new Range2(this.start.row, 0, Math.max(this.start.row, this.end.row - 1), 0);
            else return new Range2(this.start.row, 0, this.end.row, 0);
          };
        ...
        function() {
          ...
          TextInput2.prototype.handleClipboardData = function(e, data, forceIEMime) {
            ...
            try {
              ...
              if (!forceIEMime) return this.handleClipboardData(e2, data, true);
            }
          };
        ...
        function() {
          ...
          DefaultHandlers2.prototype.onMouseDown = function(ev) {
            ...
            if (button !== 0) {
              ...
              if (selectionEmpty || button == 1) editor2.selection.moveToPosition(pos);
              if (button == 2) {
          ...
          DefaultHandlers2.prototype.startSelect = function(pos, waitForClickSelection) {
            ...
            if (this.mousedownEvent.getShiftKey()) editor2.selection.selectToPosition(pos);
            else if (!waitForClickSelection) editor2.selection.moveToPosition(pos);
          ...
          DefaultHandlers2.prototype.onMouseWheel = function(ev) {
            ...
            var canScroll = false;
            if (direction >= 1 && editor2.renderer.isScrollableBy(ev.wheelX * ev.speed, 0)) canScroll = true;
            if (direction <= 1 && editor2.renderer.isScrollableBy(0, ev.wheelY * ev.speed)) canScroll = true;
            if (canScroll) {
    ...
    ace.define("ace/mouse/default_gutter_handler", [
      ...
      function GutterHandler(mouseHandler) {
        ...
        mouseHandler.editor.setDefaultHandler("guttermousedown", function(e) {
          if (!editor2.isFocused() || e.getButton() != 0) return;
        ...
        function showTooltip() {
          ...
          if (row == maxRow) {
            ...
            if (screenRow > editor2.session.documentToScreenRow(pos.row, pos.column)) return hideTooltip();
          }
      ...
      function DragdropHandler(mouseHandler) {
        ...
        this.onDragEnd = function(e) {
          ...
          if (!editor2.getReadOnly()) {
            ...
            if (!dragOperation && dropEffect == "move") editor2.session.remove(editor2.getSelectionRange());
        ...
        this.onDragEnter = function(e) {
          if (editor2.getReadOnly() || !canAccept(e.dataTransfer)) return;
          x = e.clientX;
          y = e.clientY;
        ...
        function autoScroll(cursor, prevCursor) {
          ...
          if (vScroll || hScroll && !vMovement) {
            ...
            else if (now - autoScrollStartTime >= AUTOSCROLL_DELAY) editor2.renderer.scrollCursorIntoView(scrollCursor);
          } else {
        ...
        function addDragMarker() {
          ...
          if (editor2.isFocused()) editor2.renderer.$cursorLayer.setBlinking(false);
        ...
        function clearDragMarker() {
          ...
          if (editor2.isFocused() && !isInternal) editor2.$resetCursorStyle();
          range = null;
          dragCursor = null;
          counter = 0;
          autoScrollStartTime = null;
      ...
      exports2.addTouchListeners = function(el, editor2) {
          ...
          var handleClick = function(e) {
            ...
            if (action == "paste") {
              ...
              if (action == "cut" || action == "copy") {
                if (clipboard) clipboard.writeText(editor2.getCopyText());
            ...
            isOpen = false;
            if (action != "openCommandPalette") editor2.focus();
          };
        ...
        event.addListener(el, "touchmove", function(e) {
          ...
          if (mode == "scroll") {
            ...
            if (mode == "cursor") editor2.selection.moveCursorToPosition(pos2);
            else if (mode == "anchor") editor2.selection.setSelectionAnchor(pos2.row, pos2.column);
        ...
        function animate() {
          ...
          animationTimer = setInterval(function() {
            ...
            if (oldScrollTop == editor2.session.getScrollTop()) animationSteps = 0;
          }, 10);
        }
      };
    });
        ...
        function() {
          function MouseHandler2(editor2) {
            ...
            var focusEditor = function(e) {
              ...
              editor2.focus();
              setTimeout(function() {
                if (!editor2.isFocused()) editor2.focus();
              });
            };
            ...
            editor2.on("mousemove", function(e) {
          ...
          MouseHandler2.prototype.captureMouse = function(ev, mouseMoveHandler) {
            ...
            var onMouseMove = function(e) {
              if (!e) return;
              if (useragent.isWebKit && !e.which && self2.releaseMouse) return self2.releaseMouse();
              self2.x = e.clientX;
              self2.y = e.clientY;
            ...
            var onCaptureEnd = function(e) {
              ...
              if (editor2.session) onCaptureUpdate();
          ...
          function FoldHandler2(editor2) {
            ...
            editor2.on("gutterclick", function(e) {
              ...
              if (gutterRegion == "foldWidgets") {
                var row = e.getDocumentPosition().row;
                var session = editor2.session;
                if (session.foldWidgets && session.foldWidgets[row]) editor2.session.onFoldWidgetClick(row, e);
                if (!editor2.isFocused()) editor2.focus();
                e.stop();
              }
            });
    ...
    ace.define("ace/lib/bidiutil", [
      ...
      exports2.doBidiReorder = function(text, textCharTypes, isRtl) {
        ...
        if (chars[chars.length - 1] === exports2.DOT) levels[chars.length - 1] = exports2.B;
        if (chars[0] === "\u202B") levels[0] = exports2.RLE;
        ...
        function() {
          ...
          BidiHandler2.prototype.setRtlDirection = function(editor2, isRtlDir) {
            ...
            for (var row = editor2.selection.getSelectionAnchor().row; row <= cursor.row; row++) {
              if (!isRtlDir && editor2.session.getLine(row).charAt(0) === editor2.session.$bidiHandler.RLE) editor2.session.doc.removeInLine(row, 0, 1);
              else if (isRtlDir && editor2.session.getLine(row).charAt(0) !== editor2.session.$bidiHandler.RLE) editor2.session.doc.insert({
                column: 0,
                row
              }, editor2.session.$bidiHandler.RLE);
            }
          };
        ...
        function() {
          function Selection2(session) {
            ...
            this.cursor.on("change", function(e) {
              ...
              if (!self2.$silent) self2._emit("changeCursor");
              if (!self2.$isEmpty && !self2.$silent) self2._emit("changeSelection");
              if (!self2.$keepDesiredColumnOnChange && e.old.column != e.value.column) self2.$desiredColumn = null;
            });
    ...
    ace.define("ace/mode/behaviour/cstyle", [
      ...
      var initContext = function(editor2) {
        ...
        if (editor2.multiSelect) {
          ...
          if (contextCache.rangeCount != editor2.multiSelect.rangeCount) contextCache = {
            rangeCount: editor2.multiSelect.rangeCount
          };
        }
          ...
          if (text.length == 1 && quotes[text]) {
            ...
            if (selected !== "" && (selected.length != 1 || !quotes[selected]) && editor2.getWrapBehavioursEnabled()) {
              ...
              if (rightChar == quote) {
                ...
                if (!shouldPairQuotes && isWordBefore || isWordAfter) return null;
      ...
      CstyleBehaviour.isSaneInsertion = function(editor2, session) {
        ...
        if (!this.$matchTokenType(iterator.getCurrentToken() || "text", SAFE_INSERT_IN_TOKENS)) {
          if (/[)}\]]/.test(editor2.session.getLine(cursor.row)[cursor.column])) return true;
        ...
        this.createModeDelegates = function(mapping) {
          ...
          for (var i in mapping) {
            if (mapping[i]) {
              ...
              if (!mode) config.$modes[id] = mode = new Mode2();
      ...
      var LineWidgets = (
        ...
        function() {
          ...
          LineWidgets2.prototype.attach = function(editor2) {
            if (editor2 && editor2.widgetManager && editor2.widgetManager != this) editor2.widgetManager.detach();
            if (this.editor == editor2) return;
            this.detach();
            this.editor = editor2;
            if (editor2) {
        ...
        function() {
          function BackgroundTokenizer2(tokenizer, session) {
            ...
            this.$worker = function() {
              ...
              while (self2.lines[currentLine]) currentLine++;
              ...
              if (startLine <= endLine) self2.fireUpdateEvent(startLine, endLine);
            };
          }
      ...
      var EditSession = (
        ...
        function() {
          function EditSession2(text, mode) {
            ...
            this.$onChange = this.onChange.bind(this);
            if (typeof text != "object" || !text.getLine) text = new Document(
              /**@type{string}*/
              text
            );
          ...
          EditSession2.prototype.documentToScreenPosition = function(docRow, docColumn) {
            if (typeof docColumn === "undefined") var pos = this.$clipPositionToDocument(
              /**@type{Point}*/
              docRow.row,
              /**@type{Point}*/
              docRow.column
        ...
        function wordBoundary(c, firstChar2) {
          ...
          if (wordRegExp.test(c) || options.regExp) {
            if (supportsLookbehind && options.$supportsUnicodeFlag) {
              if (firstChar2) return "(?<=^|[^\\p{L}\\p{N}_])";
              return "(?=[^\\p{L}\\p{N}_]|$)";
            }
            return "\\b";
          }
      ...
      var CommandManager = (
        ...
        function(_super) {
          ...
          CommandManager2.prototype.exec = function(command, editor2, args) {
            if (Array.isArray(command)) {
              for (var i = command.length; i--; ) {
                if (this.exec(command[i], editor2, args)) return true;
              }
              return false;
            }
          ...
          CommandManager2.prototype.canExecute = function(command, editor2) {
            ...
            if (editor2 && editor2.$readOnly && !command.readOnly) return false;
            if (this.$checkCommandState != false && command.isAvailable && !command.isAvailable(editor2)) return false;
            return true;
          };
          ...
          CommandManager2.prototype.replay = function(editor2) {
            ...
            if (this.recording) return this.toggleRecording(editor2);
            try {
              this.$inReplay = true;
              this.macro.forEach(function(x) {
                if (typeof x == "string") this.exec(x, editor2);
                else this.exec(x[0], editor2, x[1]);
              }, this);
            } finally {
              this.$inReplay = false;
            }
      ...
      exports2.commands = [
        ...
        },
        {
          ...
          exec: function(editor2, line) {
            if (typeof line === "number" && !isNaN(line)) editor2.gotoLine(line);
            editor2.prompt({
              $type: "gotoLine"
            });
          },
        ...
        },
        {
          ...
          exec: function(editor2) {
            if (editor2.selection.isEmpty()) editor2.selection.selectWord();
            else editor2.findNext();
          },
          readOnly: true
        },
        {
        ...
        },
        {
          ...
          exec: function(editor2) {
            ...
            if (!range.isEmpty()) editor2.session.remove(range);
            editor2.clearSelection();
          },
          scrollIntoView: "cursor",
          multiSelectAction: "forEach"
        ...
        },
        {
          ...
          exec: function(editor2) {
            ...
            editor2.insert("\n");
            if (cursor.row === 0) editor2.navigateUp();
          },
          multiSelectAction: "forEach",
          scrollIntoView: "cursor"
        },
    ...
    ace.define("ace/editor", [
        ...
        function() {
          ...
          Editor2.prototype.setKeyboardHandler = function(keyboardHandler, cb) {
            if (keyboardHandler && typeof keyboardHandler === "string" && keyboardHandler != "ace") {
              ...
              config.loadModule([
                ...
                if (_self.$keybindingId == keyboardHandler) _self.keyBinding.setKeyboardHandler(module3 && module3.handler);
                cb && cb();
              });
            } else {
          ...
          Editor2.prototype.$highlightBrackets = function() {
            ...
            setTimeout(function() {
              ...
              if (!ranges && session.$mode.getMatching) ranges = session.$mode.getMatching(self2.session);
              if (!ranges) {
                if (self2.getHighlightIndentGuides()) self2.renderer.$textLayer.$highlightIndentGuide();
                return;
              }
          ...
          Editor2.prototype.setAutoScrollEditorIntoView = function(enable) {
            ...
            var onBeforeRender = this.renderer.on("beforeRender", function() {
              if (shouldScroll) rect = self2.renderer.container.getBoundingClientRect();
            });
      ...
      var relativeNumberRenderer = {
        ...
        detach: function(editor2) {
          if (editor2.renderer.$gutterLayer.$renderer == this) editor2.renderer.$gutterLayer.$renderer = null;
        ...
        function() {
          ...
          Text2.prototype.$renderToken = function(parent, screenColumn, token, value) {
            ...
            while (m = re.exec(value)) {
              ...
              var cjkSpace = m[4];
              var cjk = m[5];
              if (!self2.showSpaces && simpleSpace) continue;
          ...
          Text2.prototype.$getFoldLineTokens = function(row, foldLine) {
            ...
            function addTokens(tokens2, from, to) {
              ...
              while (col < to && idx < tokens2.length) {
                ...
                } else renderTokens.push(tokens2[idx]);
                col += value.length;
                idx += 1;
              }
            }
            ...
            foldLine.walk(function(placeholder, row2, column, lastColumn, isNewRow) {
              if (placeholder != null) {
                ...
                if (isNewRow) tokens = session.getTokens(row2);
          ...
          VScrollBar2.prototype.onMouseDown = function(eType, e) {
            ...
            if (e.target === this.inner) {
              ...
              var onScrollInterval = function() {
                ...
                if (scrollTop === self2.scrollTop) return;
                self2._emit("scroll", {
                  data: scrollTop
                });
              };
          ...
          HScrollBar2.prototype.onMouseDown = function(eType, e) {
            ...
            if (e.target === this.inner) {
              ...
              var onScrollInterval = function() {
                ...
                if (scrollLeft === self2.scrollLeft) return;
                self2._emit("scroll", {
                  data: scrollLeft
                });
              };
...
.ace_hidden_token {
      ...
      var VirtualRenderer = (
        ...
        function() {
          ...
          VirtualRenderer2.prototype.getLastFullyVisibleRow = function() {
            ...
            if (top - this.session.getScrollTop() > config2.height - config2.lineHeight) return lastRow - 1;
            return lastRow;
          };
          ...
          VirtualRenderer2.prototype.$renderChanges = function(changes, force) {
            ...
            if (changes & this.CHANGE_FULL) {
              ...
              if (this.$showGutter) this.$gutterLayer.update(config2);
              if (this.$customScrollbar) {
            ...
            if (changes & this.CHANGE_SCROLL) {
              this.$changedLines = null;
              if (changes & this.CHANGE_TEXT || changes & this.CHANGE_LINES) this.$textLayer.update(config2);
              else this.$textLayer.scrollLines(config2);
              if (this.$showGutter) {
                if (changes & this.CHANGE_GUTTER || changes & this.CHANGE_LINES) this.$gutterLayer.update(config2);
                else this.$gutterLayer.scrollLines(config2);
              }
              if (this.$customScrollbar) {
                this.$scrollDecorator.$updateDecorators(config2);
              }
            ...
            if (changes & this.CHANGE_TEXT) {
              ...
              if (this.$updateLines() || changes & this.CHANGE_GUTTER && this.$showGutter) this.$gutterLayer.update(config2);
              if (this.$customScrollbar) {
                this.$scrollDecorator.$updateDecorators(config2);
              }
              ...
              if (this.$highlightGutterLine) this.$gutterLayer.updateLineHighlight(config2);
              if (this.$customScrollbar) {
                this.$scrollDecorator.$updateDecorators(config2);
              }
            }
          ...
          VirtualRenderer2.prototype.setGhostText = function(text, position) {
            ...
            if (textChunks.length > 1) {
              ...
              textChunks.slice(1).forEach(function(el2) {
                ...
                if (el2.wrapped) chunkDiv.className = "ghost_text_line_wrapped";
                if (el2.text.length === 0) el2.text = " ";
          ...
          VirtualRenderer2.prototype.setTheme = function(theme, cb) {
            ...
            function afterLoad(module3) {
              ...
              if (!module3 || !module3.cssClass) throw new Error("couldn't load module " + theme + " or it didn't call define");
              if (module3.$id) _self.$themeId = module3.$id;
          ...
          VirtualRenderer2.prototype.$addResizeObserver = function() {
            ...
            this.$resizeTimer = lang.delayedCall(function() {
              if (!self2.destroyed) self2.onResize();
            }, 50);
    ...
    ace.define("ace/mouse/multi_select_handler", [
      ...
      function onMouseDown(e) {
        ...
        if (editor2.$mouseHandler.$enableJumpToDef) {
          ...
          else if (alt && editor2.$blockSelectEnabled) selectionMode = "block";
        } else {
          if (accel && !alt) {
            selectionMode = "add";
        ...
        if (selectionMode == "add") {
          ...
          var blockSelect = function() {
            ...
            if (isSamePoint(screenCursor, newCursor) && isSamePoint(cursor2, selection.lead)) return;
            screenCursor = newCursor;
            editor2.selection.moveToPosition(cursor2);
            editor2.renderer.scrollCursorIntoView();
            editor2.removeSelectionMarkers(rectSel);
            rectSel = selection.rectangularRangeBlock(screenCursor, screenAnchor);
            if (editor2.$mouseHandler.$clickSelection && rectSel.length == 1 && rectSel[0].isEmpty()) rectSel[0] = editor2.$mouseHandler.$clickSelection.clone();
    ...
    ace.define("ace/commands/multi_select_commands", [
      ...
      exports2.defaultCommands = [
        ...
        },
        {
          ...
          exec: function(editor2) {
            if (editor2.multiSelect.rangeCount > 1) editor2.multiSelect.joinSelections();
            else editor2.multiSelect.splitIntoLines();
          },
          bindKey: {
            win: "Ctrl-Alt-L",
            mac: "Ctrl-Alt-L"
    ...
    ace.define("ace/multi_select", [
      ...
      function MultiSelect(editor2) {
        if (editor2.$multiselectOnSessionChange) return;
    ...
    ace.define("ace/ext/error_marker", [
      ...
      exports2.showErrorMarker = function(editor2, dir) {
        ...
        w.destroy = function() {
          if (editor2.$mouseHandler.isMousePressed) return;
        ...
        editor2.renderer.scrollCursorIntoView(null, 0.5, {
    ...
    ace.define("ace/ace", [
      ...
      exports2.edit = function(el, options) {
        ...
        var editor2 = new Editor(new Renderer(el), doc, options);
        var env = {
          document: doc,
          editor: editor2,
...
// src/bundle/parser.js
var require_parser = __commonJS({
  "src/bundle/parser.js"(exports, module) {
    "use strict";
